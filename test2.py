...
base_path = '/home/dat/Downloads/06/image_0/'
...
cam = PinholeCamera(1226.0, 370.0, 718.8560, 718.8560, 613.0, 185.0)
...
vo = VisualOdometry(cam, annotations)
...
# Vẽ quỹ đạo
traj = np.array(traj)
plt.plot(traj[:, 0], traj[:, 2], label="Estimated")
